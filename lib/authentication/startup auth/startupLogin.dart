...
class StartupLoginWidget extends StatefulWidget {
  StartupLoginWidget({
    Key? key,
  }) : super(key: key);

  @override
  _StartupLoginWidget createState() => _StartupLoginWidget();
}

class _StartupLoginWidget extends State<StartupLoginWidget> {
  late bool isInv;
  String email = '';
  String password = '';
  String error = '';
