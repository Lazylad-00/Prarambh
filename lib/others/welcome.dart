...
class WelcomeInvestor extends StatelessWidget {
  const WelcomeInvestor({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Thanks for joining! Get started on your journey and explore inspiring and awesome startups!',
